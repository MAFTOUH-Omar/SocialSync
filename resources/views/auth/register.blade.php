...
<body class="bg-slate-200">
    <div class="flex">
        ...
        <div class="flex justify-center items-start md:w-1/2 flex-col">
            ...
            <button id="open-modal-button" class="w-1/2 bg-blue-500 hover:bg-blue-400 shadow-lg mb-1 rounded-3xl flex items-center justify-center py-2 px-14" data-modal-toggle="register-modal">
